...
PX_LINE_TEXT_SEPARATION : Dimension = Dimension.from_px(4)
BARHEIGHT : Dimension = Dimension.from_px(8)
CH_ACTOR_SPAN_SEPARATION : Dimension = Dimension.from_ch(6)
PX_ACTORBAR_SEPARATION : Dimension = Dimension.from_px(4)
